...
"""
dsn_hostname = "2d46b6b4-cbf6-40eb-bbce-6251e6ba0300.bs2io90108kqb10d8icg.databases.appdomain.cloud"
dsn_uid = "cmm81287"
dsn_pwd = "Os47OPOfg4C4Yird"
...
app.config['hostname'] = '2d46b6b4-cbf6-40eb-bbce-6251e6ba0300.bs2io90108kqb10d8icg.databases.appdomain.cloud'
app.config['port'] = '32328'
app.config['protocol'] = 'tcpip'
app.config['uid'] = 'cmm81287'
app.config['pwd'] = 'Os47OPOfg4C4Yird'
app.config['security'] = 'SSL'
try:
    mysql = DB2(app)

    conn_str='database=bludb;hostname=2d46b6b4-cbf6-40eb-bbce-6251e6ba0300.bs2io90108kqb10d8icg.databases.appdomain.cloud;port=32328;protocol=tcpip;\
            uid=cmm81287;pwd=Os47OPOfg4C4Yird;security=SSL'
